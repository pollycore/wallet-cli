...
- `test_cli_core.py`: parser, version, upgrade preflight, and generic CLI rendering helpers
...
- `test_test_command.py`: `pw test` fixture loading, placeholder resolution, and subset assertions
