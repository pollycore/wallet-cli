...
- For interactive self-upgrade prompts, treat plain `Enter` as a decline and keep the prompt label aligned as `[y/N]` so accidental upgrades do not run when the user just dismisses the question.
