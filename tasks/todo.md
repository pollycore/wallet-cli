...
- Tightened `/Users/jorgemf/Git/wallet-cli/tests/test_test_command.py` to lock in `✅ Test passed: <path>` for explicit fixture runs and plain `✅ Test passed` for default `pw-tests` sweeps.
